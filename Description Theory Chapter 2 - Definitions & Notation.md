...
The goal of this version is not yet to present the final canonical Chapter 2. Instead, it gathers the repeated material from earlier draft layers into one agreed section structure so that each section can be discussed and merged one by one.
